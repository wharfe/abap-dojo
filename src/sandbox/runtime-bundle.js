// Generated by scripts/build-runtime-bundle.mjs from @abaplint/runtime@2.13.74. Do not edit.
"use strict";
var abaplintRuntime = (() => {
  ...
  var require_structure = __commonJS({
    "node_modules/@abaplint/runtime/build/src/types/structure.js"(exports2) {
      ...
      var upperCaseCache = /* @__PURE__ */ new Map();
      ...
      var Structure = class _Structure {
        ...
        constructor(fields, qualifiedName, ddicName, suffix, asInclude, cloning = false) {
          ...
          if (cloning === true) {
            ...
            this.qualifiedName = qualifiedName === void 0 ? void 0 : cachedUpperCase(qualifiedName);
            this.ddicName = ddicName === void 0 ? void 0 : cachedUpperCase(ddicName);
          }
          this.suffix = suffix;
        ...
        clone() {
          ...
          const n = new _Structure(newValues, this.qualifiedName, this.ddicName, this.suffix, this.asInclude, true);
          return n;
        }
        clear() {
        ...
        set(input) {
          ...
          if (input instanceof field_symbol_1.FieldSymbol) {
            ...
            for (let i2 = 0; i2 < keys1.length; i2++) {
              ...
              const val = obj[key1];
              if (val instanceof _Structure || val instanceof table_1.Table || val instanceof table_1.HashedTable) {
    ...
    "node_modules/@abaplint/runtime/build/src/types/decfloat34.js"(exports2) {
      ...
      var DecFloat34 = class _DecFloat34 {
        ...
        set(value) {
          ...
          } else if (value instanceof _DecFloat34) {
  ...
  var require_integer8 = __commonJS({
    "node_modules/@abaplint/runtime/build/src/types/integer8.js"(exports2) {
      ...
      var decfloat34_1 = require_decfloat34();
    ...
    "node_modules/@abaplint/runtime/build/src/types/float.js"(exports2) {
      ...
      var Float = class _Float {
        ...
        set(value) {
          ...
          } else if (value instanceof _Float || value instanceof decfloat34_1.DecFloat34) {
            this.value = value.getRaw();
          } else if (value instanceof hex_1.Hex || value instanceof xstring_1.XString) {
            this.set(parseInt(value.get(), 16));
          } else {
  ...
  var require_packed = __commonJS({
    "node_modules/@abaplint/runtime/build/src/types/packed.js"(exports2) {
      ...
      var integer8_1 = require_integer8();
      var decfloat34_1 = require_decfloat34();
      var digits = new RegExp(/^\s*-?\+?\d*\.?\d*(?:E[+-]?\d+)? *$/i);
      function pow10(exp) {
  ...
  var require_initial = __commonJS({
    "node_modules/@abaplint/runtime/build/src/compare/initial.js"(exports2) {
      ...
      function initial(val) {
        ...
        } else if (val instanceof types_12.Float || val instanceof types_12.DecFloat34) {
          return val.getRaw() === 0;
  ...
  var require_eq = __commonJS({
    "node_modules/@abaplint/runtime/build/src/compare/eq.js"(exports2) {
      ...
      var IntegerC = types_12.Integer;
      var StringC = types_12.String;
      var CharacterC = types_12.Character;
      var NumcC = types_12.Numc;
      var DateC = types_12.Date;
      var TimeC = types_12.Time;
      var PackedC = types_12.Packed;
      var FloatC = types_12.Float;
      var DecFloat34C = types_12.DecFloat34;
      var TableC = types_12.Table;
      var HashedTableC = types_12.HashedTable;
      var StructureC = types_12.Structure;
      var XStringC = types_12.XString;
      var HexC = types_12.Hex;
      var HexUInt8C = types_12.HexUInt8;
      var Integer8C = types_12.Integer8;
      var ABAPObjectC = types_12.ABAPObject;
      var DataReferenceC = types_12.DataReference;
      function eq(left, right) {
        ...
        if (right instanceof types_12.Character) {
          ...
          if (left instanceof types_12.Packed) {
            ...
            return right.get() === left.get();
          } else if (left instanceof types_12.DecFloat34) {
            return right.get() === left.getRaw();
          }
        ...
        } else if (right instanceof types_12.DecFloat34) {
          if (left instanceof types_12.Float || left instanceof types_12.DecFloat34) {
            return right.getRaw() === left.getRaw();
          } else if (left instanceof types_12.Integer || left instanceof types_12.Packed) {
            return right.getRaw() === left.get();
          }
        }
  ...
  var require_sort = __commonJS({
    "node_modules/@abaplint/runtime/build/src/statements/sort.js"(exports2) {
      "use strict";
      Object.defineProperty(exports2, "__esModule", { value: true });
      exports2.compareRows = compareRows;
      exports2.sort = sort;
      var types_12 = require_types();
      ...
      function compareRows(a, b, keyFields) {
        if (keyFields.length > 0) {
          for (const keyField of keyFields) {
            ...
            const result = component === "table_line" ? compareWholeRows(a, b) : compare(a, b, { component });
            if (result !== 0) {
              return result;
            }
          }
  ...
  var require_insert_internal = __commonJS({
    "node_modules/@abaplint/runtime/build/src/statements/insert_internal.js"(exports2) {
      ...
      function insertInternal(options) {
        ...
        const isSorted = tableOptions?.primaryKey?.type === types_12.TableAccessType.sorted || tableOptions?.primaryKey?.type === types_12.TableAccessType.hashed;
        if (isSorted === true && !(options.table instanceof types_12.HashedTable) && options.index === void 0 && options.lines !== true) {
        ...
        if (data && options.index) {
          ...
          if (options.table instanceof types_12.HashedTable) {
            const { value: val2, subrc } = options.table.insert(options.table.getRowType());
            if (subrc === 0) {
              if (options.assigning) {
                options.assigning.assign(val2);
              }
              if (options.referenceInto) {
                options.referenceInto.assign(val2);
              }
            }
            ...
            if (input.dynamicSource instanceof types_12.ABAPObject || input.dynamicSource instanceof types_12.DataReference) {
              ...
              for (const s of split) {
                ...
                if (upperS === "*") {
                  ...
                  input.dynamicSource = input.dynamicSource.getPointer();
                  if (input.dynamicSource instanceof types_12.Table || input.dynamicSource instanceof types_12.HashedTable) {
                  ...
                  if (sourceContainer instanceof types_12.DataReference) {
                    sourceContainer = sourceContainer.getPointer();
                  }
                  if (sourceContainer instanceof types_12.Table || sourceContainer instanceof types_12.HashedTable) {
                  ...
                  const componentName = sourceContainer instanceof types_12.Structure ? s.toLowerCase() : s.toLowerCase().replace(/[~\\/]/g, "$");
        ...
        if (input.lines === true) {
          ...
          if (tab instanceof types_12.Table) {
            ...
            for (let i2 = 0; i2 < length; i2++) {
              if (hasSeparator === true && i2 > 0) {
                result += sep;
              }
              const value = array[i2].get();
    ...
    "node_modules/@abaplint/runtime/build/src/statements/delete_internal.js"(exports2) {
      ...
      async function deleteInternal(target, options) {
        ...
        if (options?.to) {
          ...
          for (let i2 = to; i2 >= from; i2--) {
            target.deleteIndex(i2 - 1);
          }
          return;
        }
      ...
      async function unpack(source, target) {
        ...
        if (source instanceof types_12.Character && target instanceof types_12.Character) {
          ...
          if (sourceValue.length > 0 && /^\d+$/.test(sourceValue) === false) {
            await (0, throw_error_1.throwErrorWithParameters)("CX_SY_CONVERSION_NO_NUMBER", { value: new types_12.String().set(sourceValue) });
          }
  ...
  var require_select = __commonJS({
    "node_modules/@abaplint/runtime/build/src/statements/select.js"(exports2) {
      ...
      async function select(target, input, runtimeOptions, context) {
        ...
        if (rows.length === 0) {
          if (runtimeOptions?.appending !== true && (target instanceof types_12.Table || target instanceof types_12.HashedTable)) {
            target.clear();
          }
  ...
  var require_wait = __commonJS({
    "node_modules/@abaplint/runtime/build/src/statements/wait.js"(exports2) {
      ...
      async function wait(options) {
        const timeout = options.seconds === void 0 ? void 0 : options.seconds.get() * 1e3;
        const deadline = timeout === void 0 ? void 0 : Date.now() + timeout;
        while (true) {
          if (options.cond() === true) {
            abap.builtin.sy.get().subrc.set(0);
            return;
          }
          const remaining = deadline === void 0 ? 500 : deadline - Date.now();
          if (remaining <= 0) {
  ...
  // node_modules/@abaplint/runtime/build/src/statements/skip.js
  var require_skip = __commonJS({
    "node_modules/@abaplint/runtime/build/src/statements/skip.js"(exports2) {
      "use strict";
      Object.defineProperty(exports2, "__esModule", { value: true });
      exports2.SkipStatement = void 0;
      var SkipStatement = class {
        context;
        constructor(context) {
          this.context = context;
        }
      ...
      exports2.SkipStatement = SkipStatement;
    }
  });
    ...
    "node_modules/@abaplint/runtime/build/src/template_formatting.js"(exports2) {
      ...
      function templateFormatting(source, options) {
        ...
        if (source instanceof types_12.FieldSymbol) {
          ...
          if (options?.decimals) {
            text2 = source.toFixed(options.decimals);
          } else {
            text2 = source.toFixed(source.getDecimals());
          }
        ...
        if (options) {
          ...
          if (options.date === "iso") {
            ...
            const yyyy = text2.substr(0, 4);
            const mm = text2.substr(4, 2);
            const dd = text2.substr(6, 2);
            const date = /* @__PURE__ */ new Date(`${yyyy}-${mm}-${dd}T00:00:00`);
            if (isNaN(date.getTime())) {
              text2 = "00000000";
            } else {
              text2 = new Intl.DateTimeFormat("default", { day: "2-digit", month: "2-digit", year: "numeric" }).format(date);
            }
          }
          if (options.time === "iso") {
            text2 = text2.substr(0, 2) + ":" + text2.substr(2, 2) + ":" + text2.substr(4, 2);
          } else if (options.time === "user" || options.time === "environment") {
            const hh = text2.substr(0, 2);
            const mm = text2.substr(2, 2);
            const ss = text2.substr(4, 2) || "00";
            const timeDate = /* @__PURE__ */ new Date(`1970-01-01T${hh}:${mm}:${ss}`);
            if (isNaN(timeDate.getTime())) {
              text2 = "";
            } else {
              text2 = new Intl.DateTimeFormat("default", {
                hour: "2-digit",
                minute: "2-digit",
                second: "2-digit"
              }).format(timeDate);
  ...
  // node_modules/@abaplint/runtime/build/src/builtin/acos.js
  var require_acos = __commonJS({
    "node_modules/@abaplint/runtime/build/src/builtin/acos.js"(exports2) {
      "use strict";
      Object.defineProperty(exports2, "__esModule", { value: true });
      exports2.acos = acos;
      var types_12 = require_types();
  ...
  // node_modules/@abaplint/runtime/build/src/builtin/asin.js
  var require_asin = __commonJS({
    "node_modules/@abaplint/runtime/build/src/builtin/asin.js"(exports2) {
      "use strict";
      Object.defineProperty(exports2, "__esModule", { value: true });
      exports2.asin = asin;
      var types_12 = require_types();
  ...
  // node_modules/@abaplint/runtime/build/src/builtin/atan.js
  var require_atan = __commonJS({
    "node_modules/@abaplint/runtime/build/src/builtin/atan.js"(exports2) {
      "use strict";
      Object.defineProperty(exports2, "__esModule", { value: true });
      exports2.atan = atan;
      var types_12 = require_types();
  ...
  // node_modules/@abaplint/runtime/build/src/builtin/cosh.js
  var require_cosh = __commonJS({
    "node_modules/@abaplint/runtime/build/src/builtin/cosh.js"(exports2) {
      "use strict";
      Object.defineProperty(exports2, "__esModule", { value: true });
      exports2.cosh = cosh;
      var types_12 = require_types();
  ...
  // node_modules/@abaplint/runtime/build/src/builtin/exp.js
  var require_exp = __commonJS({
    "node_modules/@abaplint/runtime/build/src/builtin/exp.js"(exports2) {
      "use strict";
      Object.defineProperty(exports2, "__esModule", { value: true });
      exports2.exp = exp;
      var types_12 = require_types();
    ...
    "node_modules/@abaplint/runtime/build/src/builtin/frac.js"(exports2) {
      ...
      function frac(input) {
        ...
        if (typeof input.val === "number") {
          ...
          num_in = input.val.getCalculationValue();
        } else if (input.val instanceof types_12.DecFloat34) {
          num_in = input.val.getRaw();
        } else {
          num_in = parseFloat(input.val.get().toString());
        }
    ...
    "node_modules/@abaplint/runtime/build/src/operators/add.js"(exports2) {
      ...
      function add(left, right) {
        if (left instanceof types_12.Integer && right instanceof types_12.Integer) {
          ...
          return new types_12.Integer().set(Number.parseInt(left.get(), 10) + right.get()).clearIntegerCalculationType();
          ...
          return new types_12.Integer().set(left.get() + Number.parseInt(right.get(), 10)).clearIntegerCalculationType();
          ...
          return new types_12.Integer().set(Number.parseInt(left.get(), 10) + Number.parseInt(right.get(), 10)).clearIntegerCalculationType();
        } else if (left instanceof types_12.Integer8) {
  ...
  var require_divide = __commonJS({
    "node_modules/@abaplint/runtime/build/src/operators/divide.js"(exports2) {
      ...
      function divide(left, right) {
        ...
        const val = l / r;
        const ret = new types_12.Float().set(val);
      ...
      function isIntegerOperand(val) {
        if (val instanceof types_12.Integer) {
          return val.isIntegerCalculationType();
        }
        return val instanceof types_12.Integer8;
      }
    }
  });
    ...
    "node_modules/@abaplint/runtime/build/src/operators/multiply.js"(exports2) {
      ...
      function multiply(left, right) {
        if (left instanceof types_12.Integer8 || right instanceof types_12.Integer8) {
          ...
          return new types_12.Integer().set(val).clearIntegerCalculationType();
        } else if ((right instanceof string_1.String || right instanceof types_12.Character) && Number.isInteger(Number(right)) && left instanceof types_12.Integer) {
  ...
  // node_modules/@abaplint/runtime/build/src/builtin/log.js
  var require_log = __commonJS({
    "node_modules/@abaplint/runtime/build/src/builtin/log.js"(exports2) {
      "use strict";
      Object.defineProperty(exports2, "__esModule", { value: true });
      exports2.log = log;
      var types_12 = require_types();
  ...
  // node_modules/@abaplint/runtime/build/src/builtin/log10.js
  var require_log10 = __commonJS({
    "node_modules/@abaplint/runtime/build/src/builtin/log10.js"(exports2) {
      "use strict";
      Object.defineProperty(exports2, "__esModule", { value: true });
      exports2.log10 = log10;
      var types_12 = require_types();
    ...
    "node_modules/@abaplint/runtime/build/src/builtin/replace.js"(exports2) {
      ...
      function replace(input) {
        ...
        if (typeof withSource === "string") {
          wi = withSource;
        } else if (withSource instanceof types_12.Character) {
        ...
        if (typeof subSource === "string") {
          sub = subSource;
        } else if (subSource instanceof types_12.Character) {
        ...
        if (input.off && input.len && typeof source === "string") {
          ...
          const offset = input.off.get();
          const length = input.len.get();
          val = source.getOffset({ offset: 0, length: offset }).get() + wi + source.getOffset({ offset: offset + length }).get();
  ...
  // node_modules/@abaplint/runtime/build/src/builtin/sinh.js
  var require_sinh = __commonJS({
    "node_modules/@abaplint/runtime/build/src/builtin/sinh.js"(exports2) {
      "use strict";
      Object.defineProperty(exports2, "__esModule", { value: true });
      exports2.sinh = sinh;
      var types_12 = require_types();
  ...
  var require_substring_after = __commonJS({
    "node_modules/@abaplint/runtime/build/src/builtin/substring_after.js"(exports2) {
      ...
      function substring_after(input) {
        ...
        if (source instanceof types_12.Character) {
          val = source.getTrimEnd();
        }
        let reg = "";
        if (typeof input.regex === "string") {
  ...
  var require_sy = __commonJS({
    "node_modules/@abaplint/runtime/build/src/builtin/sy.js"(exports2) {
      ...
      exports2.sy = new types_12.Structure({
        ...
        mandt: new types_12.Character(3, { qualifiedName: "SY-MANDT", ddicName: "MANDT" }).set("123"),
        ...
        // 0 = UTC
        zonlo: new types_12.Character(6).set("UTC"),
        uname: new types_12.Character(12, { qualifiedName: "SY-UNAME", ddicName: "UNAME" }).set("USERNAME"),
  ...
  // node_modules/@abaplint/runtime/build/src/builtin/tanh.js
  var require_tanh = __commonJS({
    "node_modules/@abaplint/runtime/build/src/builtin/tanh.js"(exports2) {
      "use strict";
      Object.defineProperty(exports2, "__esModule", { value: true });
      exports2.tanh = tanh;
      var types_12 = require_types();
  ...
  var require_to_lower = __commonJS({
    "node_modules/@abaplint/runtime/build/src/builtin/to_lower.js"(exports2) {
      ...
      function to_lower(input) {
        ...
        if (source instanceof types_12.Character) {
          return new types_12.Character(source.getLength()).set(val.toLowerCase());
        } else {
  ...
  var require_to_upper = __commonJS({
    "node_modules/@abaplint/runtime/build/src/builtin/to_upper.js"(exports2) {
      ...
      function to_upper(input) {
        ...
        const val = typeof source === "string" ? source : source.get();
        if (source instanceof types_12.Character) {
          return new types_12.Character(source.getLength()).set(val.toUpperCase());
        } else {
          return new types_12.String().set(val.toUpperCase());
        }
      }
  ...
  var require_translate2 = __commonJS({
    "node_modules/@abaplint/runtime/build/src/builtin/translate.js"(exports2) {
      ...
      function translate(input) {
        ...
        let toSource;
        if (input.to instanceof types_12.FieldSymbol) {
        ...
        if (toSource instanceof types_12.Character) {
  ...
  var require_builtin = __commonJS({
    "node_modules/@abaplint/runtime/build/src/builtin/index.js"(exports2) {
      ...
      __exportStar(require_acos(), exports2);
      __exportStar(require_asin(), exports2);
      __exportStar(require_atan(), exports2);
      ...
      __exportStar(require_log10(), exports2);
      ...
      __exportStar(require_sinh(), exports2);
      ...
      __exportStar(require_tanh(), exports2);
  ...
  var require_expand_dynamic = __commonJS({
    "node_modules/@abaplint/runtime/build/src/expand_dynamic.js"(exports2) {
      ...
      var types_12 = require_types();
      function expandDynamic(input, evaluate2) {
        let code;
        if (input instanceof types_12.Table || input instanceof types_12.HashedTable) {
  ...
  var require_dynamic_call_lookup = __commonJS({
    "node_modules/@abaplint/runtime/build/src/dynamic_call_lookup.js"(exports2) {
      ...
      function findFriendInterfaceMethod(obj, name) {
        const suffix = "$" + name;
        const found = Object.keys(obj.FRIENDS_ACCESS_INSTANCE || {}).filter((key) => key.endsWith(suffix)).map((key) => obj.FRIENDS_ACCESS_INSTANCE[key]);
        return found.length === 1 ? found[0] : void 0;
      }
      function dynamicCallLookup(obj, methodName) {
        ...
        if (ret === void 0 && name.includes("$") === false) {
        ...
        setHandler(event, methods, forObject, activation) {
          ...
          if (activation === true) {
            ...
            const index = handlers.findIndex((handler) => {
              const sameObject = handler.forObject === "ALL" ? target === "ALL" : target !== "ALL" && handler.forObject.deref() === target;
              const sameMethod = handler.handlers[0].method === methods[0].method && handler.handlers[0].receiver === methods[0].receiver;
  ...
  var require_index = __commonJS({
    "node_modules/@abaplint/runtime/build/src/index.js"(exports2) {
      ...
      var builtin = __importStar(require_builtin());
      var compare = __importStar(require_compare());
      var DB = __importStar(require_db());
      exports2.DB = DB;
      var operators = __importStar(require_operators());
      var RFC = __importStar(require_rfc());
      exports2.RFC = RFC;
